...
export default function Nav() {
  ...
  return (
    <nav className="mx-auto max-w-screen-xl">
      {/* We normally have a padding right of 10 and left of 5, and always justify to the end, but on medium screens we justify between
      (Due to the source code button) */}
      <div
        className={
          "my-4 flex items-center justify-end px-10 text-white"
        }
      >
        <div>
          {/* primary nav */}
